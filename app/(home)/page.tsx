        ...
        <div className="prose mt-6 flex-1">
          ...
          <ul>
            ...
            <li>
              ...
              serialization or even serialize to a different language/spec
            </li>
            <li className="ml-5">
          ...
          <ul>
            <li>
              <code>text</code> - The type and JSDoc comment are derived from
              the database schema.
            </li>
            <li>
            ...
            <Callout>
              All user defined methods on the resource or its underlying model
              are considered uninferrable because the return type is not
              reasonably guaranteed.
              <p>
                Notably, this also applies to methods that override the
                generated attribute methods from <code>ActiveRecord</code>.
              </p>
            </Callout>
            <li>
