...
| [`rbs`](#rbs)                                                                           | `"off" \| "fallback"`                                     | `"off"`                  |
| [`rbs_sig_path`](#rbs_sig_path)                                                         | `String`                                                  | `Rails.root.join("sig")` |
...
| ---------------------------------------- | ------------------------------- | ------------------------- |
| `false`                                  | `false`                         | RBS signature of Model    |
| `false`                                  | `true`                          | Inferred type for Model   |
| `true`                                   | `false`                         | RBS signature of Resource |
| `true`                                   | `true`                          | RBS signature of Resource |
