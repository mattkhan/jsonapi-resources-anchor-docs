...
Install via Bundler and git: https://bundler.io/guides/git.html

```ruby title="Gemfile"
gem 'jsonapi-resources-anchor', '~> 1.0',
  git: 'https://github.com/mattkhan/jsonapi-resources-anchor',
  branch: 'main',
  ref: '...'
```
